$(document).ready(function(){
    var dataLogin = localStorage.getItem("GHY_Mlogin");
  ...
  $('.subArea button').click(function() {
            ...
            $.post(''+EQD_url+'/Training/Add_trainingDemand.ashx', {
    ...
    $('.peixuntheme').dblclick(function(){
        ...
        function loadApply(page){
                $.post(''+EQD_url+'/Training/Get_trainingApply_byHR.ashx', {
                "userGuid" : dataLogined.Guid,
                "type" : 1,
                "comid" : dataLogined.companyId,
                "page" : page
    ...
    $.post(''+EQD_url+'/Option_AreasAnd.ashx',{type:"0"} ,function(data) {
          areadata= data;
