(function(a) {
  ...
  a.confirm = function(k, g) {
    ...
    var b = "";
    if (d.title !== "") {
      b = '<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title">' + d.title + "</h4></div>"
    }
    var h = "";
    if (d.cancelButton) {
      h = '<button class="cancel btn ' + d.cancelButtonClass + '" type="button" data-dismiss="modal" id="cancel">' + d.cancelButton + "</button>"
    }
    var f = '<div class="confirmation-modal modal fade" tabindex="-1" role="dialog"><div class="' + d.dialogClass + '"><div class="modal-content">' + b + '<div class="modal-body">' + d.text + '</div><div class="modal-footer"><button class="confirm btn ' + d.confirmButtonClass + '" type="button" data-dismiss="modal" id="sure">' + d.confirmButton + "</button>" + h + "</div></div></div></div>";
    var i = a(f);
